...
export default class SupplierMeetingSystem {
    ...
    getPrice(gangId, basePrice = CONFIG.RAW_MATERIAL_COST) {
        ...
        const loyaltyBonus = this.getLoyalty(gangId) >= CONFIG.LOALTY_THRESHOLD ? 0.9 : 1.0;
    ...
    getQuality(gangId) {
        ...
        const loyaltyBonus = this.getLoyalty(gangId) >= CONFIG.LOALTY_THRESHOLD ? 0.1 : 0;
    ...
    getDialog(gangId, context = 'buy') {
        ...
        } else if (loyalty >= CONFIG.LOALTY_THRESHOLD) {
