...
function savePNG(canvas, filepath) {
    ...
    console.log(`Would save ${canvas.width}x${canvas.height} sprite to: ${filepath}`);
...
function generatePlayerSprites() {
    ...
    console.log('Player sprites generated!');
}
...
function generateNPCSprites() {
    ...
    npcs.forEach(npc => {
        ...
        console.log(`  ${npc.name}: ${directions.length} walk sheets, ${battlePoses.length} battle sheets, ${expressions.length} portraits`);
    });
}

function generateObjectSprites() {
    console.log('\n=== Generating Object Sprites ===\n');
    ...
    console.log('Cardboard box: 3 state sheets');
    ...
    console.log('Storage unit: 4 state sheets');
    ...
    console.log('Workstation: 3 state sheets');
    
    console.log('\nObject sprites generated!');
}
...
function main() {
    console.log('╔════════════════════════════════════════════════╗');
    console.log('║   TRAP Animated Sprite Generator               ║');
    console.log('║   Art Direction: Mirren                        ║');
    console.log('║   2D/3D Modeling: Prism                        ║');
    console.log('╚════════════════════════════════════════════════╝');
    ...
    console.log(`  - ${NPC_DIR}`);
    console.log(`  - ${OBJ_DIR}`);
    console.log('\nNote: These are PPM placeholder files.');
    console.log('Replace with proper pixel art for production.');
